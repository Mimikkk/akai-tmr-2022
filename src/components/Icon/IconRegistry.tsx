...
const createIcon = (element: ReactElement) => (props: IconProps) => cloneElement(Children.only(element)!, props);
...
const QuestionCircle = createIcon(
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
    <path
